...
import 'package:ymi_chat_app/widgets/chat_input_widget.dart';
import 'package:ymi_chat_app/widgets/chat_widget.dart';
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ChatWidget(
                chat: chats[index - 1],
                isReceived: currentUser.email != chats[index - 1].from.email,
                showUser: (index == 1) ||
                    (index >= 2 &&
                        !(chats[index - 1].from.email ==
                            chats[index - 2].from.email)),
              );
            },
